						...
						<div className="tab-content" id="myTabContent">
							<div className="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabIndex={0}>
								<div className="m-1">
									...
									<input type="email" className="form-control" id="loginEmail" placeholder="name@example.com" onBlur={(e) => setLoginData({ ...loginData, email: e.target.value })} />
								</div>
								<div className="m-1">
									<label htmlFor="exampleFormControlInput1" className="form-label">
										Введите пароль
									...
									<div className="input-group mb-3">
										<input
											type={passwordVisible.log ? "text" : "password"}
								...
								<div className="m-1">
									<button type="button" className="btn btn-primary w-100" data-bs-dismiss="modal" disabled={loginData.email === "" || loginData.password.length < 6} onClick={handleLogIn}>
										Войти
									</button>
								</div>
							</div>
							...
							<div className="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabIndex={0}>
								...
								<div className="m-1">
									...
									<div className="input-group mb-3">
										<input
											type={passwordVisible.reg ? "text" : "password"}
								...
								<div className="m-1">
									...
									<div className="input-group mb-3">
										<input
											type={passwordVisible.regConfirm ? "text" : "password"}
											...
											onBlur={(e) => {
												setErrors({
													...errors,
													[e.target.id]: validate(e.target.id, e.target.value, registrationData.registrationPassword)
												})
											}}
										/>
										<button
											...
											onClick={() =>
												setPasswordVisible({
													...passwordVisible,
													regConfirm: !passwordVisible.regConfirm
												})
											}
										>
								...
								<div className="form-check m-2">
									<input
										...
										onChange={() => {
											setRegistrationData({
												...registrationData,
												subscribe: !registrationData.subscribe
											})
										}}
									/>
								...
								<div className="m-1">
									<button
										...
										disabled={
											...
											registrationData.registrationPhone === "" ||
											registrationData.registrationPassword === "" ||
											(document.querySelector("#registrationConfirmPassword") as HTMLInputElement).value.length < 6
										}
								...
								<label className="form-check-label m-1" htmlFor="flexCheckDefault">
									Нажимая кнопку `&quot;`Зарегистрироваться`&quot;`, Вы соглашаетесь c условиями <Link to={"/" + sex + "/policy"}>политики конфиденциальности</Link>
								</label>
							</div>
						</div>
					</div>
