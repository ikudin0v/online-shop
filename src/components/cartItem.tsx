					...
					<div className="card-body ps-3 pt-0">
						...
						<div className="d-flex flex-row">
							...
							<div className="input-group" style={{ width: 7 + "em", height: 1 + "em" }}>
								<button className="btn btn-outline-primary" type="button" id="button-addon2" onClick={() => changeQuantity(cartItem, "desc")}>
									-
								</button>
								...
								<button className="btn btn-outline-primary" type="button" id="button-addon2" onClick={() => changeQuantity(cartItem, "asc")}>
									+
								</button>
							</div>
						</div>
